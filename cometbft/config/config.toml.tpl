...
#######################################################
### Experimental Controller Mediation Configuration ###
#######################################################
[experimental_controller]

# Controller mediation is unsafe on an untrusted network unless external
# authentication and transport security are provided. It is disabled by default.
enabled = {{ .ExperimentalController.Enabled }}
controller_address = "{{ .ExperimentalController.ControllerAddress }}"
callback_listen_address = "{{ .ExperimentalController.CallbackListenAddress }}"
callback_advertise_address = "{{ .ExperimentalController.CallbackAdvertiseAddress }}"
node_id = {{ .ExperimentalController.NodeID }}
outbound_queue_capacity = {{ .ExperimentalController.OutboundQueueCapacity }}
outbound_queue_bytes = {{ .ExperimentalController.OutboundQueueBytes }}
callback_queue_capacity = {{ .ExperimentalController.CallbackQueueCapacity }}
callback_queue_bytes = {{ .ExperimentalController.CallbackQueueBytes }}
callback_max_body_bytes = {{ .ExperimentalController.CallbackMaxBodyBytes }}
counter_registry_capacity = {{ .ExperimentalController.CounterRegistryCapacity }}
registration_attempts = {{ .ExperimentalController.RegistrationAttempts }}
registration_retry_delay = "{{ .ExperimentalController.RegistrationRetryDelay }}"
request_timeout = "{{ .ExperimentalController.RequestTimeout }}"
send_timeout = "{{ .ExperimentalController.SendTimeout }}"
shutdown_timeout = "{{ .ExperimentalController.ShutdownTimeout }}"
