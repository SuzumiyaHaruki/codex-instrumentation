...
func PrometheusMetrics(namespace string, labelsAndValues ...string) *Metrics {
	...
	return &Metrics{
		...
		ControllerMediationTotal: prometheus.NewCounterFrom(stdprometheus.CounterOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "controller_mediation_total",
			Help:      "Number of controller-mediation events by bounded event, class, and message type.",
		}, append(labels, "event", "error_class", "message_type")).With(labelsAndValues...),
	}
}
...
func NopMetrics() *Metrics {
	return &Metrics{
		...
		ControllerMediationTotal: discard.NewCounter(),
	}
}
