...
type Metrics struct {
	...
	// Number of controller-mediation events by bounded event, class, and message type.
	ControllerMediationTotal metrics.Counter `metrics_labels:"event,error_class,message_type"`
}
